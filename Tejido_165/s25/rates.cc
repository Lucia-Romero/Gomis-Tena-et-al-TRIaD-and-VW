...
void human::rates(int x) 
{
	...
	dO_IKr_D   =     ai* 0 * p->I_IKr_D  + aa* 0              * p->C1_IKr_D + kO_D * Dofetilide * p->O_IKr  - p->O_IKr_D  *(bi *0 + bb *0 + rO_D); 
	dC1_IKr_D  =     ain   * p->C2_IKr_D + bb* 0              * p->O_IKr_D  + kC_D * Dofetilide * p->C1_IKr - p->C1_IKr_D *(aa *0 + bin   + rC_D); 
	...
	dI_IKr_D   =     bi* 0 * p->O_IKr_D  + kI_D  * Dofetilide * p->I_IKr    - p->I_IKr_D  * ( ai *0 + rI_D ); 	
