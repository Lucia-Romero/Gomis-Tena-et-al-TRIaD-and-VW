...
void RGC() {
    ...
    k1_O_drug  = hh*(ai*0*I_drug + aa*0*C1_drug+ kO_D*Drug*O  - O_drug *(bi*0 + bb*0  + rO_D)); //foot
    k1_C1_drug = hh*(ain*C2_drug + bb*0*O_drug + kC_D*Drug*C1 - C1_drug*(aa*0 + bin   + rC_D)); //foot
    ...
    k1_I_drug  = hh*(bi*0*O_drug               + kI_D*Drug*I_ - I_drug *(ai*0 + rI_D)); // foot
    ...
    k2_O_drug  = hh*(ai*0*I_drug_k1 + aa*0*C1_drug_k1+ kO_D*Drug*O_k1  - O_drug_k1 *(bi*0 + bb*0+rO_D)); //foot
    k2_C1_drug = hh*(ain*C2_drug_k1 + bb*0*O_drug_k1 + kC_D*Drug*C1_k1 - C1_drug_k1*(aa*0 + bin +rC_D)); //foot
    ...
    k2_I_drug  = hh*(bi*0*O_drug_k1                  + kI_D*Drug*I_k1  - I_drug_k1 *(ai*0 + rI_D)); // foot
    ...
    k3_O_drug  = hh*(ai*0*I_drug_k2 + aa*0*C1_drug_k2 + kO_D*Drug*O_k2  - O_drug_k2 *(bi*0 + bb*0+ rO_D)); // foot
    k3_C1_drug = hh*(ain*C2_drug_k2 + bb*0*O_drug_k2  + kC_D*Drug*C1_k2 - C1_drug_k2*(aa*0 + bin + rC_D));// foot
    ...
    k3_I_drug  = hh*(bi*0 *O_drug_k2                  + kI_D*Drug*I_k2  - I_drug_k2 *(ai*0 + rI_D)); //foot
    ...
    k4_O_drug  = hh*(ai *0*I_drug_k3+ aa*0*C1_drug_k3+ kO_D*Drug*O_k3 - O_drug_k3 *(bi*0 + bb*0+ rO_D)); //foot
    k4_C1_drug = hh*(ain*C2_drug_k3 + bb*0*O_drug_k3 + kC_D*Drug*C1_k3 - C1_drug_k3*(aa*0+ bin + rC_D)); //foot
    ...
    k4_I_drug  = hh*(bi*0 *O_drug_k3                 + kI_D*Drug*I_k3  - I_drug_k3 *(ai*0 + rI_D));      //foot
	...
	if (fabs (sum2 -1.0) > 0.001) {cout << "Error in Sum at t = " << t << endl;}
		...
		double 	GKr = 0.024 * 1.7575 * 1.119 * 0.37397;  		
